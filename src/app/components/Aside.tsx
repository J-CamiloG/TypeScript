        ...
        <aside className="bg-gradient-to-br from-gray-800 to-gray-900 -translate-x-80 fixed inset-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0">
            <div className="relative border-b border-white/20">
                <p  className="flex items-center gap-4 py-6 px-8" >
                    <span className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-white">Menu</span>
                </p>
            ...
            <ul className="mb-4 flex flex-col gap-1">
                ...
                <a className="" href="#">
                    ...
                    <p className="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">temas</p>
                    </button>
                </a>
                </li>
                <li>
                <a className="" href="#">
                    ...
                    <p className="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">nuevo</p>
                    </button>
                </a>
                </li>
            </ul>
